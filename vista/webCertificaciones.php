    ...
    <main class="main">
        <div class="main-overview">
            <div class="card text-center tabla">
                <h5 class="card-header" style="width:100%;">Certificaciones</h5>
                <div class="card-text">
                    <table class="table table-sm table-striped" >
                        <thead>
                            <tr>
                                <td scope="col" style="width: 300px">#</td>
                                <td scope="col" style="width: 300px">Estudiantes</td>
                                <td scope="col" style="width: 300px">Tipo Certificacion</td>
                                <td scope="col" style="width: 300px">Nota</td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                ...
                                $certificaciones = $cc->obtenerCertificacion();
                                for ($i=0; $i < sizeof($certificaciones); $i++) {
                                    echo "<tr>";
                                    echo "<th scope='row'>".$certificaciones[$i]->getIdCertificacion()."</th>";
                                    echo "<td>".$certificaciones[$i]->getIdEstudiante()."</td>";
                                    echo "<td>".$certificaciones[$i]->getIdTipo()."</td>";
                                    echo "<td>".$certificaciones[$i]->getNota()."</td>";
                                    echo "</tr>";
                                }
                            ?>
                        </tbody>
